...
Public Class Form1
    Dim sqlCon As New SqlConnection("server=DELL-PC\SQLEXPRESS; database=course ; integrated security=true") ' معلومات الاتصال بالداتابيس
    Public Property nameStudent As String
    Public Property theId As Integer
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Label2.Text = nameStudent '"The Subject that student taken"
        Dim x As Integer
        x = 1
        sqlCon.Open()
        '---------------كويري لست للمواد ----------------------
